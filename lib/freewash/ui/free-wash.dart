...
class _FreeWashState extends State<FreeWash>
  ...
  static const List<SliderModel> _items = const <SliderModel>[
    ...
    const SliderModel(
        ...
        title: 'Gift A Wash',
        subTitle:
            "The best way to show appreciation is when one needs it most. Gift a wash to ease the load",
        link: 'GIFT'),
  ];
                                ...
                                children: [
                                  new Card(
                                    child: new Container(
                                        padding: const EdgeInsets.all(10.0),
                                        child: new Text(
                                            'For every action you take to help us grow you earn points, 1000 points equals to one basic load. Each friend that signs up and pays for their first wash you and your friend received 1000 points equaling to free wash fro you and your friend. If your friend signed up for a subscription you both get one month free.'),
                                        height: 180.0,
